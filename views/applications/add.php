...
<head>
    ...
    <title>Ajouter une candidature - HelloCandidate</title>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto py-8 px-4">
        <h1 class="text-2xl font-bold text-indigo-700 mb-8">Ajouter une candidature</h1>
        ...
        <form action="/applications/add" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="company_name" id="company_name" value="<?php echo htmlspecialchars($companyName ?? ''); ?>" 
                        class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select name="status" id="status" class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mt-4">
                ...
                <textarea name="description" id="description" rows="4" 
                    class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"><?php echo htmlspecialchars($description ?? ''); ?></textarea>
            </div>
            <div class="mt-4">
